...
const string fileNameGenCandidatesNoFilter = "dcap://t2-srm-02.lnl.infn.it//pnfs/lnl.infn.it/data/cms/store/user/slacapra/B0KsMuMu/Data2012B0KstMuMuResults/MonteCarlo2012/ForEfficiency/B0ToPsi2SKst_GEN_NoFilter_MC_NTuples_addGENvars.root";
const string fileNameRecoCandidates        = "dcap://t2-srm-02.lnl.infn.it////pnfs/lnl.infn.it/data/cms/store/user/slacapra/B0KsMuMu/Data2012B0KstMuMuResults/MonteCarlo2012/ForEfficiency/B0ToPsi2SKst_MC_NTuple_addGENvars.root";
const string fileNameSingleCand            = "dcap://t2-srm-02.lnl.infn.it////pnfs/lnl.infn.it/data/cms/store/user/slacapra/B0KsMuMu/Data2012B0KstMuMuResults/MonteCarlo2012/SingleCand/singleCand_B0ToPsi2SKst_MC_NTuple.root";
const string SignalType                    = "5";
  ...
  // ##########################################################
{
  ...
  ele_KEpdf->at(type-1) = new RooNDKeysPdf(Form("ele_KEpdf%i",type-1), Form("ele_KEpdf%i",type-1), RooArgList(CosThetaK,AbsCosThetaMu,AbsPhiKstMuMuPlane), KEpdf_data, "MA", width);
