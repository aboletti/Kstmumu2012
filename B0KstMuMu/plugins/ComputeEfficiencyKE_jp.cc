...
const string fileNameGenCandidatesNoFilter = "dcap://t2-srm-02.lnl.infn.it//pnfs/lnl.infn.it/data/cms/store/user/slacapra/B0KsMuMu/Data2012B0KstMuMuResults/MonteCarlo2012/ForEfficiency/B0ToJPsiKst_GEN_NoFilter_MC_NTuples_addGENvars.root";
const string fileNameRecoCandidates        = "dcap://t2-srm-02.lnl.infn.it////pnfs/lnl.infn.it/data/cms/store/user/slacapra/B0KsMuMu/Data2012B0KstMuMuResults/MonteCarlo2012/ForEfficiency/B0ToJPsiKst_MC_NTuple_addGENvars.root";
const string fileNameSingleCand            = "dcap://t2-srm-02.lnl.infn.it////pnfs/lnl.infn.it/data/cms/store/user/slacapra/B0KsMuMu/Data2012B0KstMuMuResults/MonteCarlo2012/SingleCand/singleCand_B0ToJPsiKst_MC_NTuple.root";
const string SignalType                    = "3";
  ...
  // ##########################################################
{
  ...
  if      (type == 1) {
    ...
    if (q2BinIdx==5) nEntries = nEntries/5;
  } else if (type == 2) {
    cout << " (after filter) @@@" << endl;
    if (q2BinIdx==5) nEntries = nEntries/5;
  } else if (type == 3) {
    cout << " (reco events) @@@" << endl;
    if (q2BinIdx==5) nEntries = nEntries/5;
...
void computeEffForOneBin(int q2BinIndx, bool doPlot, float width, bool crossCheck) {
  ...
  if (termIdx == 1 || termIdx == 0) {
    ...
    h3genDen->Scale(Counter[0]*norm_fac/h3genDen->Integral());
  ...
  if (termIdx == 2 || termIdx == 0) {
    ...
    h3genNum->Scale(Counter[1]*norm_fac/h3genNum->Integral());
  ...
  if (termIdx == 3 || termIdx == 0) {
    ...
    h3recoDen->Scale(Counter[2]*norm_fac/h3recoDen->Integral());
